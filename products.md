...
Bitdribble microcontainers can be used to containerize and to schedule running application code. A typical use case is to schedule periodic network tests, and to report back server or service availability.
